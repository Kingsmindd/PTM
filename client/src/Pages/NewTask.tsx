...
const NewTask: React.FC = () => {
  return (
    <div className="  w-360 mt-10 ">
      <div className="w-360  flex flex-col gap-10 font-[Signika_Negative]  ">
        <p className="flex items-center  text-[50px]  font-bold  font-[Signika_Negative]">
        ...
        <div className=" flex flex-col gap-15 relative ">
          ...
          <div className="relative">
            <label className=" left-20 absolute bg-white px-2 -top-9 text-[#9C9C9C]  font-normal text-[30px]  font-[Signika_Negative]">
              Description
            </label>
            <input
              type="text"
              placeholder="Briefly describe your task"
              className="  outline-none bg-transparent text-[#9C9C9C] w-360 border-[#9C9C9C] border-2 h-65.5 text-start pb-50 ps-7 "
            />
          </div>
          <div className="relative">
